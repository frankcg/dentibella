                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <ol class="breadcrumb float-right">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Seguimiento Citas</a></li>
                                <li class="breadcrumb-item active">Listado</li>
                            </ol>
                            <h4 class="page-title">Listado Citas En Seguimiento</h4>
                        </div>
                        <!-- End page title box -->
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive" data-pattern="priority-columns">
                                            <table id="seguimiento_table" class="table  table-striped">
                                                <thead>
                                                <tr>
                                                    ...
                                                    <!--
                                                    <th data-priority="1">Síntoma Uno</th>
                                                    <th data-priority="1">Síntoma Dos</th>
                                                    -->
                                                    <th data-priority="1">Diágnostico</th>
                                                    <th data-priority="1">Fecha Creación</th>
                                                    <th data-priority="1">Estado</th>
                                                    <th data-priority="1">En Espera</th>
                                                    <th data-priority="1">En Atención</th>
                                                    <th data-priority="1">Atendido</th>
                                                    <th data-priority="1">Ausente</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>

...
async function getReportInc() {
    ...
    if(fechaIni && fechaFin){
        ...
        $.ajax({
            url: '../../controllers/reporte.php?op=reporteInc',
            method: 'POST',
            dataType: 'json',
            data: {
                fechaIni,
            ...
            success: function (responseData) {
                ...
                let nuevos = getAlmacenados(responseData)
                let total = getEsperados(responseData)
                console.log(fechas)
                charBar('myChart','Nuevos',nuevos,'Total',total,fechas)
